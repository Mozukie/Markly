...
import Attendance from "../models/Attendance.js"; // ✅ make sure you have this
...
router.post("/", protect, async (req, res) => {
  try {
    const { classSubject, classCode, classSection, days, classTime } = req.body;
    ...
    const newClass = await Class.create({
      ...
      classCode,
      classSection,
      classDays: days || [],               // ✅ store array properly
      classTime,
      schedule: `${days.join(", ")} ${classTime}`, 
      teacher: req.user._id,
      qrLink,                        // ✅ save actual value
    });
