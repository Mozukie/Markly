            ...
            <main className="container mx-auto p-4">
                ...
                {modal && (
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-lg w-96">
                        ...
                        <div>
                            <label htmlFor="classDays" className="block text-gray-700">Days</label>
                            <select id="classDays" name="classDays" multiple
                                className="w-full px-3 py-2 border rounded"value={classData.days || []}onChange={(e) => {const selected = Array.from(e.target.selectedOptions).map(opt => opt.value);setClassData({ ...classData, days: selected });}}required >
                                <option type="checkbox" value="Monday">Monday</option>
                            ...
                            <p className="text-sm text-gray-600 mt-1">Hold Ctrl (Windows) or Cmd (Mac) to select multiple days</p>
                            </div>
