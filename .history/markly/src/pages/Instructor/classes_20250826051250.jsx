        ...
        <div>
            ...
            <main className="container mx-auto p-4">
                ...
                {qrModal && selectedClass && (
                    <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50 h-600 w-600" style={{maxWidth: '90vw', maxHeight: '90vh', overflow: 'auto'}}>
                        <div className="bg-white p-6 rounded-lg shadow-lg w-95">
                        ...
                        {/* < QRCode value={`http://localhost:5000/attendance/${selectedClass._id}?expires=${Date.now() + parseInt(expiryDuration) * 1000}`}size={200} className="mx-auto"/> */}
                        < QRCode value={`https://www.youtube.com/watch?v=dQw4w9WgXcQ?expires=${Date.now() + parseInt(expiryDuration) * 1000}`}size={500} className="mx-auto"/>
