                ...
                {modal && (
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-lg w-96">
                        ...
                        <div>
                            ...
                            <input type="day" id="classDay" name="day" className="w-full px-3 py-2 border rounded" value={classData.day} onChange={(e) => {const selectedDate = e.target.value;const dayName = new Date(selectedDate).toLocaleDateString("en-US", { weekday: "long" });setClassData({ ...classData, day: selectedDate });setWeekday(dayName);}}/>
                            {weekday && (
