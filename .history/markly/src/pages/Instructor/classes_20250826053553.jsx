            ...
            <main className="container mx-auto p-4">
                ...
                {qrModal && selectedClass && (
                    <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50">
                        ...
                        < QRCode value={`http://localhost:5000/attendance/${selectedClass._id}?expires=${Date.now() + parseInt(expiryDuration) * 1000}`} logoImage="../public/icon.png" logoWidth={100} logoHeight={100} className="mx-auto"/>
