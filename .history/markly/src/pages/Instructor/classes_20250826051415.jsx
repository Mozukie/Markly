        ...
        <div>
            ...
            <main className="container mx-auto p-4">
                ...
                {qrModal && selectedClass && (
                    <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50 h-100 w-100">
                        <div className="bg-white p-6 rounded-lg shadow-lg w-96">
                        ...
                        < QRCode value={`https://www.youtube.com/watch?v=dQw4w9WgXcQ?expires=${Date.now() + parseInt(expiryDuration) * 1000}`}size={300} className="mx-auto"/>
