                ...
                {modal && (
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-lg w-96">
                        ...
                        <div>
                            ...
                            <input type="day" id="classDay" name="day" className="w-full px-3 py-2 border rounded" value={classData.day} onChange={(e) => setClassData({ ...classData, day: e.target.value })} required />
                        </div>
                        <div>
