                    ...
                    <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50">
                        <div className="bg-white p-6 rounded-lg w-96" >
                            ...
                            <form className="space-y-4">
                                ...
                                <div>
                                    <timestamp className="block text-gray-700 mb-2" htmlFor="class-time">Class Time</timestamp>
                                    <input type="datetime-local" id="class-time" className="w-full px-3 py-2 border rounded" required />
                                </div>
