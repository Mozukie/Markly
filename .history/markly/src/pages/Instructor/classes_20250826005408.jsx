...
export default function Classes() {
    ...
    const handleSave = () => {
       ...
       const classData = {
         className: e.target.elements['class-name'].value,
         classCode: e.target.elements['class-code'].value,
                ...
                {modal && (
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-lg w-96">
                        ...
                        <div>
                            ...
                            <input type="text" id="class-name" name="class-name" className="w-full px-3 py-2 border rounded" required />
                        </div>
                        <div>
                            <label htmlFor="class-code" className="block text-gray-700">Class Code</label>
                            <input type="text" id="class-code" name="class-code" className="w-full px-3 py-2 border rounded" required />
                        </div>
