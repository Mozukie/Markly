  ...
  fetchClasses();
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            subject: e.target.classSubject.value,
            code: e.target.classCode.value,
            section: e.target.classSection.value,
            day: e.target.classDay.value,
            time: e.target.classTime.value,
            }, {
            headers: { Authorization: `Bearer ${token}` }
            });
                ...
                {modal && (
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-lg w-96">
                        ...
                        <div>
                            ...
                            <input type="text" id="classSubject" name="classSubject" className="w-full px-3 py-2 border rounded" value={classData.subject} onChange={(e) => setClassData({... classData, subject : e.target.classSubject.value})} required />
                        </div>
                        <div>
