...
export default function Login() {
  ...
  const [userRegister, setUserRegister] = useState({"firstname": "", "lastname": "", "email": "", "password": ""});
          ...
          <form className="w-full flex flex-col items-center" onSubmit={handleRegister}>
            <div className="mb-3 w-3/4 flex gap-3">
              <div className="w-1/2">
                ...
                <input type="text" id="reg-firstname" className="w-full px-2 py-1.5 border rounded text-center" value={(userRegister)} onChange={(e) => setUserRegister({... userRegister, firstname : e.target.value})} required />
              </div>
              <div className="w-1/2">
                <label className="block text-gray-700 mb-1 text-center" htmlFor="reg-lastname">Last Name</label>
                <input type="text" id="reg-lastname" className="w-full px-2 py-1.5 border rounded text-center"  value={(userRegister)} onChange={(e) => setUserRegister({... userRegister, lastname : e.target.value})} required />
              </div>
            </div>
            <div className="mb-3 w-3/4">
              <label className="block text-gray-700 mb-1 text-center" htmlFor="reg-email">Email</label>
              <input type="email" id="reg-email" className="w-full px-2 py-1.5 border rounded text-center"  value={(userRegister)} onChange={(e) => setUserRegister({... userRegister, email : e.target.value})} required />
            </div>
            <div className="mb-3 w-3/4">
              <label className="block text-gray-700 mb-1 text-center" htmlFor="reg-password">Password</label>
              <input type="password" id="reg-password" className="w-full px-2 py-1.5 border rounded text-center"  value={(userRegister)} onChange={(e) => setUserRegister({... userRegister, password : e.target.value})} required />
            </div>
            <div className="mb-3 w-3/4">
