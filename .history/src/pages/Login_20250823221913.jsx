...
export default function Login() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex  justify-between px-4">
        {/* Login Panel */}
        <div
        ...
        {/* Register Panel */}
        <div
          className={`bg-white p-6 rounded-xl shadow-2xl max-w-md w-full mr-24 flex flex-col items-center transition-all duration-500 z-30 mt-13 ${showRegister ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8 pointer-events-none'}`}
