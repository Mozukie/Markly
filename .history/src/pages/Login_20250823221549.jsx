  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-between px-4">
        ...
        {/* Register Panel */}
        <div
          className={`bg-white p-6 rounded-xl shadow-2xl max-w-md w-full mr-24 flex flex-col items-center transition-all duration-500 z-30 mt-15 ${showRegister ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8 pointer-events-none'}`}
